- Week_1 -> Basic Defination of the dynamics, obstacle configurations and animation scripts. I manually create a brute forced trajectory that is working(not optimized).
- Week_2 -> Direct Throwing transcription, optimized using using fmincon NLP solver.
